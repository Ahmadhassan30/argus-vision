...
across the Docker boundary. They are kept in sync only by a comment — so this
test fails loudly if someone changes one resize / crop / normalization value and
forgets the other.
"""
